...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        rubik: ['var(--font-body, var(--font-rubik))', 'Rubik', 'sans-serif'],
        /** Hebrew snippet on EN pages — always next/font Rubik, ignores --font-body */
        'he-rubik': ['var(--font-rubik)', 'Rubik', 'sans-serif'],
        marketing: ['var(--font-body, var(--font-rubik))', 'Rubik', 'sans-serif'],
        simpler: ['var(--font-body, var(--font-rubik))', 'Rubik', 'sans-serif'],
        assistant: ['var(--font-body, var(--font-rubik))', 'Rubik', 'sans-serif'],
        heebo: ['var(--font-body, var(--font-rubik))', 'Rubik', 'sans-serif'],
