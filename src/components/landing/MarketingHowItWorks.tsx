      ...
      */}
      <div className="relative mx-auto flex w-full max-w-[1004px] flex-col items-center gap-[30px] self-stretch md:gap-12">
        ...
        <LandingReveal className="relative z-[1] hidden w-full text-center md:block">
          <h2 className="landing-gradient-title bg-gradient-to-b from-[#efefef] from-[10%] to-[#d1d1d1] to-[94%] bg-clip-text font-rubik text-[40px] font-bold leading-[1.25] tracking-[-0.9px] text-transparent lg:text-[45px]">
            {ui.howTitleDesktop}
          </h2>
