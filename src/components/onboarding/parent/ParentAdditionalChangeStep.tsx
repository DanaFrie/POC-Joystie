...
export function ParentAdditionalChangeStep({
  ...
  return (
    <div dir="rtl" className="relative h-full w-full overflow-hidden">
      ...
      <OnboardingFunnelScrollBody scrollRef={scrollRef}>
        <div
          className="flex w-full flex-col px-v03-gutter pb-6"
          style={{ paddingTop: layout.contentTop, gap: layout.sectionGap }}
      ...
      <div
        className="absolute left-v03-gutter z-[45] flex w-v03-content flex-col pt-5"
