...
const UI_HE = {
  ...
  howMockChildName: 'אלון',
  howMockMinutes: '40 דקות',
  howMockDailyAvg: 'ממוצע דק׳ יומי של אלון',
  howMockValue: '52 דק׳',
  ...
  /** Mobile — matches main */
  howTitle: 'איך עובד התהליך איתנו?',
  howTitleDesktop: 'איך עובד התהליך עם ג׳ויסטי?',
  howLead: 'נלווה אתכם בכל שלב עד שתצליחו לשלב את ההרגלים החדשים בחיי הילדים',
  /** Mobile — matches main */
  scienceTitle: 'המדע מאחורי ג׳ויסטי',
  scienceTitleDesktop: 'המדע והנתונים שתומכים בג׳ויסטי',
  scienceLead:
    'מאחורי כל פיצ׳ר בג׳ויסטי עומדים עקרונות מוכחים ממדעי ההתנהגות, שנועדו לעזור לילדים לפתח הרגלים בריאים בעולם הדיגיטלי',
  ...
  footerMountainM1: 'בונים יחד עם',
  footerMountainM2: 'הילדים הרגלי',
  footerMountainM3: 'מסך בריאים',
  footerMountainD1: 'בונים יחד עם הילדים',
  footerMountainD2: 'הרגלי מסך בריאים',
  footerCta: 'הצטרפות לג׳ויסטי',
  footerCopyright: 'כל הזכויות שמורות ל- Joystie בע"מ ©',
...
const UI_EN = {
  ...
  howTitleDesktop: 'How does it work?',
  ...
  scienceTitleDesktop: 'The science behind Joystie',
  scienceLead:
  ...
  footerMountainM1: 'Building healthy',
  footerMountainM2: 'screen habits',
  footerMountainM3: 'together with kids',
  footerMountainD1: 'Building healthy screen habits',
  footerMountainD2: 'together with kids',
